...
np.save('/scratch/bell/hu1029/LGHW/ACtrackPoints_middle_SH.npy', trackPoints_middle)

# plot the map -------------------
fig, ax, cf = create_Map(lon,latNH,trackPoints_frequency, lowerlat=-90, upperlat=-20, fill=True,fig=None,
...
for tid, points in tid_dict.items():
    ...
    t, la, lo = points[mid_idx]
    trackPoints_middle[t, la, lo] = tid
np.save('/scratch/bell/hu1029/LGHW/CCtrackPoints_middle_SH.npy', trackPoints_middle)
