...
for dtname in datasets:
    ...
    lat_NH = lat[lat_mid:len(lat)] #0~90
    ...
    outdir = Path(OUT_DIR)
    save_dict = {
        f"{dtname}_SD_Blocking_peaking_date_daily_NH": Blocking_peaking_date,
        f"{dtname}_SD_Blocking_peaking_lon_daily_NH": Blocking_peaking_lon,
        f"{dtname}_SD_Blocking_peaking_lat_daily_NH": Blocking_peaking_lat,
        f"{dtname}_SD_BlockingTotal_date_NH": BlockingTotal_date,
        f"{dtname}_SD_BlockingTotal_label_NH": BlockingTotal_label,
        f"{dtname}_SD_BlockingTypeI_NH": BlockingTypeI,
        f"{dtname}_SD_Blocking_diversity_date_daily_NH": Blocking_diversity_date,
        f"{dtname}_SD_Blocking_diversity_label_daily_NH": Blocking_diversity_label,
        f"{dtname}_SD_Blocking_diversity_peaking_date_daily_NH": Blocking_diversity_peaking_date,
        f"{dtname}_SD_Blocking_diversity_peaking_lon_daily_NH": Blocking_diversity_peaking_lon,
        f"{dtname}_SD_Blocking_diversity_peaking_lat_daily_NH": Blocking_diversity_peaking_lat,
    ...
    #%% Save results
    save_dict = {
        f"{dtname}_SD_Seeding_peaking_date_daily_NH": Seeding_peaking_date,
        f"{dtname}_SD_Seeding_peaking_lon_daily_NH": Seeding_peaking_lon,
        f"{dtname}_SD_Seeding_peaking_lat_daily_NH": Seeding_peaking_lat,
        f"{dtname}_SD_SeedingTotal_date_NH": SeedingTotal_date,
        f"{dtname}_SD_SeedingTotal_label_NH": SeedingTotal_label,
        f"{dtname}_SD_SeedingTypeI_NH": SeedingTypeI,
        f"{dtname}_SD_Seeding_diversity_date_daily_NH": Seeding_diversity_date,
        f"{dtname}_SD_Seeding_diversity_label_daily_NH": Seeding_diversity_label,
        f"{dtname}_SD_Seeding_diversity_peaking_date_daily_NH": Seeding_diversity_peaking_date,
        f"{dtname}_SD_Seeding_diversity_peaking_lon_daily_NH": Seeding_diversity_peaking_lon,
        f"{dtname}_SD_Seeding_diversity_peaking_lat_daily_NH": Seeding_diversity_peaking_lat,
        f"{dtname}_SD_Seeding_freq_NH": SD_freq
    }
    ...
    plt.ylabel('Latitude')
    plt.savefig(f'{dtname}_SD_blockingFreq_daily_watershed_NH.png')  
    plt.show()
    plt.close()
    ...
    plt.xlabel('Longitude')
    plt.ylabel('Latitude')
    plt.savefig(f'{dtname}_SD_seedingFreq_daily_watershed_NH.png')  
    plt.show()
    plt.close()
