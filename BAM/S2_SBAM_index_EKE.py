...
IN_DIR_List = {
    "ERA5": "/scratch/bell/hu1029/Data/processed/ERA5_EKE_total_1979_2021",
    "MERRA2": "/scratch/bell/hu1029/Data/processed/MERRA2_EKE_total_1980_2021",
    "JRA55": "/scratch/bell/hu1029/Data/processed/JRA55_EKE_total_1979_2021"
}
OUT_DIR_List = {
...
for dtname in datasets:
    ...
    for kk in ['SH','NH']:
        ...
        if dtname == "JRA55":
            # JRA55 has pressure levels in Pa, convert to hPa
            lev0 = lev0 / 100
        fil.close()
        ...
        if not os.path.exists(f'{OUT_DIR}/{dtname}_EKE_ZM_{kk}_total_{yearname}_1dg.npy'):
            ...
            for year, file in enumerate(files):
                with Dataset(file, 'r') as fil:
                    ...
                    print(n_days_in_file, flush=True)                    
        ...
        ### Daily Climatology, it should be a 365-day array, this is to remove the seasonal cycle ###
        ...
        #%% Step4: anomaly and EOF analysis --------------------------
