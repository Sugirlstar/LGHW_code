...
IN_DIR_List_u = {
    ...
    "JRA55": "/scratch/bell/hu1029/Data/processed/JRA55_UV_1dg/JRA55_U_6hr_*.nc"
}
IN_DIR_List_v = {
    ...
    "JRA55": "/scratch/bell/hu1029/Data/processed/JRA55_UV_1dg/JRA55_V_6hr_*.nc"
}
varnameList_u = {
    "ERA5": "u",
    "MERRA2": "U",
...
def process_one_year(dtname, target_year):
    ...
    outfile_check = os.path.join(OUTDIR, f"{dtname}_NH_TROP_{year}.nc")
