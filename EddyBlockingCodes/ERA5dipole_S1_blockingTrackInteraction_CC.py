...
for typeid in [1,2,3]:
    ...
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_BlockingType{typeid}_EventEddyNumberSector2_1979_2021_CC.npy', np.array(EddyNumberSec2))
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_TrackBlockingType{typeid}_IndexSector2_1979_2021_CC.npy', np.array(BlockIndexSec2))
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_BlockingType{typeid}_ThroughTrackSec2_1979_2021_CC.npy', np.array(ThroughTrackSec2))
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_BlockingType{typeid}_AbsorbedTrackSec2_1979_2021_CC.npy', np.array(AbsorbedTrackSec2))
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_BlockingType{typeid}_EdgeTrackSec2_1979_2021_CC.npy', np.array(EdgeTrackSec2))
    np.save(f'/scratch/bell/hu1029/LGHW/ERA5dipole_BlockingType{typeid}_InteractionTypeSec2_1979_2021_CC.npy', np.array(InterTypeSec2))
