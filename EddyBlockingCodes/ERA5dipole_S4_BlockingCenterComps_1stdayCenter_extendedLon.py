...
for typeid in [1,2,3]:
    ...
    np.save('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredLWA_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy', centeredLWAnpy)
    np.save('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredZ500_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy', centeredZ500npy)
    np.save('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredAC_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy', centeredACnpy)
    np.save('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredCC_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy', centeredCCnpy)

    centeredLWAnpy = np.load('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredLWA_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy')
    centeredZ500npy = np.load('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredZ500_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy')
    centeredACnpy = np.load('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredAC_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy')
    centeredCCnpy = np.load('/scratch/bell/hu1029/LGHW/ERA5dipole_1stBlkDay_CenteredCC_timewindow41_extendedLon_BlkType'+str(typeid)+'.npy')
    ...
    for tid in timestep:
        ...
        makeMap(lonarr, latarr, centeredLWAnpyti, AC_lat_idx, AC_lon_idx, CC_lat_idx, CC_lon_idx, f'ERA5dipole_ACtrackdensityLWA_1stBlkDay_CenterOverlap_extendedLon_BlkType{typeid}_day{tid/4}.png')
        makeMap(lonarr, latarr, centeredZ500npyti, AC_lat_idx, AC_lon_idx, CC_lat_idx, CC_lon_idx, f'ERA5dipole_ACtrackdensityZ500anom_1stBlkDay_CenterOverlap_extendedLon_BlkType{typeid}_day{tid/4}.png')
...
plt.savefig('centerComposites_allpanels_1stBlkDay_extendedLon_.png', dpi=300)
plt.show()
plt.close()
